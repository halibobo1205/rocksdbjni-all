...
public interface AdvancedColumnFamilyOptionsInterface
   ...
   *     {@link CompressionType} instances.
   *
   * @return the reference to the current options.
   */
  ...
  /**
   * <p>Return the currently set {@link CompressionType}
   * per instances.</p>
   *
   * <p>See: {@link #setCompressionPerLevel(List)}</p>
   *
   * @return list of {@link CompressionType}
   *     instances.
   */
