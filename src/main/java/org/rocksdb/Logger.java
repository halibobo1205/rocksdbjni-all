 ...
 *
 * <p>
 * A log level can be set using {@link Options} or
...
public abstract class Logger extends RocksCallbackObject {
   ...
   * the {@link Options} instance will be used as
   ...
   *
   * <p><strong>Important:</strong> the log level set within
   * the {@link DBOptions} instance will be used
   * as maximum log level of RocksDB.</p>
   *
   * @param dboptions {@link DBOptions} instance.
   */
  ...
  /**
   * Set {@link InfoLogLevel} to AbstractLogger.
   *
   * @param infoLogLevel {@link InfoLogLevel} instance.
   */
   ...
   *
   * @return {@link InfoLogLevel} instance.
   */
