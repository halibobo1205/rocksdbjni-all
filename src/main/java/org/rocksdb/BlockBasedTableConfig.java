...
public class BlockBasedTableConfig extends TableFormatConfig {
   ...
   *
   * {@link Cache} should not be disposed before options instances
   * using this cache is disposed.
   *
   * {@link Cache} instance can be re-used in multiple options
   * instances.
   *
   * @param cache {@link Cache} Cache java instance (e.g. LRUCache).
   * @return the reference to the current config.
   */
   ...
   *
   * {@link Filter} should not be disposed before options instances
   * using this filter is disposed. If {@link Filter#dispose()} function is not
   * called, then filter object will be GC'd automatically.
   *
   * {@link Filter} instance can be re-used in multiple options
   * instances.
   *
   * @param filter {@link Filter} Filter Policy java instance.
   * @return the reference to the current config.
   */
   ...
   *
   * @param checksumType {@link ChecksumType} value.
   * @return the reference to the current option.
   */
   ...
   *
   * @param indexType {@link IndexType} value
   * @return the reference to the current option.
   */
