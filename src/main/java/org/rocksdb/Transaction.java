 ...
 * {@link TransactionDB#beginTransaction(WriteOptions)}
 *
...
public class Transaction extends RocksObject {
   ...
   * {@link OptimisticTransactionDB#beginTransaction(WriteOptions)}
   * or {@link TransactionDB#beginTransaction(WriteOptions)}
   *
  ...
  */
   ...
   *
   * @param readOptions Read options.
   * @param columnFamilyHandles {@link List} containing
   ...
   *
   * @param readOptions Read options.
   * @param columnFamilyHandles {@link ColumnFamilyHandle}
   *     instances
  ...
  public enum TransactionState {
     ...
     *
     * @return {@link TransactionState} instance or null.
